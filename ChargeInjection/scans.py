...
# DACscan_range1_5k = range(500, 4500,250)
# DACscan_range2_5k = range(3500,30000,5000)
# DACscan_range3_5k = range(28000,49000,5000)

# DACscan_range0_5k = [60,180, 240,300]
# DACscan_range1_5k = [500,1250,2500,3250]
# DACscan_range2_5k = [4000,7000, 10000, 15000]
# DACscan_range3_5k = [35000,40000, 45000,48000]
